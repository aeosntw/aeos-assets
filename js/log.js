const ENABLE_LOGGING = localStorage.getItem('ENABLE_LOGGING') === 'true'; // ← Read from localStorage
const USE_GPS = localStorage.getItem('USE_GPS') === 'true';        // ← Read from localStorage
